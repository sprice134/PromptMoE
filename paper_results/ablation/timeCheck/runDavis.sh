...
run_and_log "DAVIS585" python RunPromptMoE.py \
    ...
    --output_dir /home/sprice/PromptMoE/paper_results/ablation/timeCheck/DAVIS585/PromptMoE-Lite \
...
run_and_log "DAVIS585" python RunPromptMoE.py \
    ...
    --pred_roots \
        /home/sprice/PromptMoE/DATASETS/DAVIS585/outputs/SP \
        /home/sprice/PromptMoE/DATASETS/DAVIS585/outputs/STM \
    --output_dir /home/sprice/PromptMoE/paper_results/ablation/timeCheck/DAVIS585/PromptMoE \
    --router_ckpt /home/sprice/PromptMoE/pairRouter_10_13.pt \
    --k_points 5 --suppression_frac 0.05 --iters 10 --beta 1.4 --router_topk 2
...
run_and_log "DAVIS585" python RunPromptMoE.py \
    ...
    --pred_roots \
        /home/sprice/PromptMoE/DATASETS/DAVIS585/outputs/SP \
        /home/sprice/PromptMoE/DATASETS/DAVIS585/outputs/STM \
    --output_dir /home/sprice/PromptMoE/paper_results/ablation/timeCheck/DAVIS585/PromptMoE-All \
...
run_and_log "DAVIS585" python samRefiner.py \
    --checkpoint /home/sprice/SAMRefiner/vit_h.pth \
    --input_root /home/sprice/PromptMoE/DATASETS/DAVIS585/images \
    --pred_roots \
        /home/sprice/PromptMoE/DATASETS/DAVIS585/outputs/SP \
        /home/sprice/PromptMoE/DATASETS/DAVIS585/outputs/STM \
    --output_dir /home/sprice/PromptMoE/paper_results/ablation/timeCheck/DAVIS585/samRefiner
...
run_and_log "DAVIS585" python DualSight.py \
    --checkpoint /home/sprice/SAMRefiner/vit_h.pth \
    --model_type vit_h \
    --input_root /home/sprice/PromptMoE/DATASETS/DAVIS585/images \
    --pred_roots \
        /home/sprice/PromptMoE/DATASETS/DAVIS585/outputs/SP \
        /home/sprice/PromptMoE/DATASETS/DAVIS585/outputs/STM \
    --output_dir /home/sprice/PromptMoE/paper_results/ablation/timeCheck/DAVIS585/DualSight
...
run_and_log "DAVIS585" python segrefiner.py \
    --input_root /home/sprice/PromptMoE/DATASETS/DAVIS585/images \
    --pred_roots \
        /home/sprice/PromptMoE/DATASETS/DAVIS585/outputs/SP \
        /home/sprice/PromptMoE/DATASETS/DAVIS585/outputs/STM \
    --output_dir /home/sprice/PromptMoE/paper_results/ablation/timeCheck/DAVIS585/segrefiner_lr \
...
run_and_log "DAVIS585" python segrefiner.py \
      ...
      --pred_roots \
        /home/sprice/PromptMoE/DATASETS/DAVIS585/outputs/SP \
        /home/sprice/PromptMoE/DATASETS/DAVIS585/outputs/STM \
      --output_dir /home/sprice/PromptMoE/paper_results/ablation/timeCheck/DAVIS585/segrefiner_hr \
      --config /home/sprice/CVPR26_Dataset/SOTA/SegRefiner/refine_mask_config.py \
...
run_and_log "DAVIS585" python cascadePSP.py \
      --input_root /home/sprice/PromptMoE/DATASETS/DAVIS585/images \
      --pred_roots \
        /home/sprice/PromptMoE/DATASETS/DAVIS585/outputs/SP \
        /home/sprice/PromptMoE/DATASETS/DAVIS585/outputs/STM \
      --output_dir /home/sprice/PromptMoE/paper_results/ablation/timeCheck/DAVIS585/cascadePSP_fast \
      --fast True
...
run_and_log "DAVIS585" python cascadePSP.py \
      ...
      --pred_roots \
        /home/sprice/PromptMoE/DATASETS/DAVIS585/outputs/SP \
        /home/sprice/PromptMoE/DATASETS/DAVIS585/outputs/STM \
      --output_dir /home/sprice/PromptMoE/paper_results/ablation/timeCheck/DAVIS585/cascadePSP_slow \
      --fast False