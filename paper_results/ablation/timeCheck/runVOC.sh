...
run_and_log "VOC" python RunPromptMoE.py \
    ...
    --output_dir /home/sprice/PromptMoE/paper_results/ablation/timeCheck/VOC/PromptMoE-Lite \
...
run_and_log "VOC" python RunPromptMoE.py \
    ...
    --pred_roots \
        ...
        /home/sprice/PromptMoE/DATASETS/VOC/outputs/FCN \
        /home/sprice/PromptMoE/DATASETS/VOC/outputs/LR-ASPP \
    --output_dir /home/sprice/PromptMoE/paper_results/ablation/timeCheck/VOC/PromptMoE \
    --router_ckpt /home/sprice/PromptMoE/pairRouter_10_13.pt \
    --k_points 5 --suppression_frac 0.05 --iters 10 --beta 1.4 --router_topk 2
...
run_and_log "VOC" python RunPromptMoE.py \
    ...
    --pred_roots \
        ...
        /home/sprice/PromptMoE/DATASETS/VOC/outputs/FCN \
        /home/sprice/PromptMoE/DATASETS/VOC/outputs/LR-ASPP \
    --output_dir /home/sprice/PromptMoE/paper_results/ablation/timeCheck/VOC/PromptMoE-All \
...
run_and_log "VOC" python samRefiner.py \
    ...
    --pred_roots \
        ...
        /home/sprice/PromptMoE/DATASETS/VOC/outputs/FCN \
        /home/sprice/PromptMoE/DATASETS/VOC/outputs/LR-ASPP \
    --output_dir /home/sprice/PromptMoE/paper_results/ablation/timeCheck/VOC/samRefiner
...
run_and_log "VOC" python DualSight.py \
    --checkpoint /home/sprice/SAMRefiner/vit_h.pth \
    --model_type vit_h \
    --input_root /home/sprice/PromptMoE/DATASETS/VOC/images \
    --pred_roots \
        ...
        /home/sprice/PromptMoE/DATASETS/VOC/outputs/FCN \
        /home/sprice/PromptMoE/DATASETS/VOC/outputs/LR-ASPP \
    --output_dir /home/sprice/PromptMoE/paper_results/ablation/timeCheck/VOC/DualSight
...
run_and_log "VOC" python segrefiner.py \
    --input_root /home/sprice/PromptMoE/DATASETS/VOC/images \
    --pred_roots \
        /home/sprice/PromptMoE/DATASETS/VOC/outputs/DeepLabV3 \
        /home/sprice/PromptMoE/DATASETS/VOC/outputs/FCN \
        /home/sprice/PromptMoE/DATASETS/VOC/outputs/LR-ASPP \
    --output_dir /home/sprice/PromptMoE/paper_results/ablation/timeCheck/VOC/segrefiner_lr \
...
run_and_log "VOC" python segrefiner.py \
      ...
      --pred_roots \
        ...
        /home/sprice/PromptMoE/DATASETS/VOC/outputs/FCN \
        /home/sprice/PromptMoE/DATASETS/VOC/outputs/LR-ASPP \
      --output_dir /home/sprice/PromptMoE/paper_results/ablation/timeCheck/VOC/segrefiner_hr \
      --config /home/sprice/CVPR26_Dataset/SOTA/SegRefiner/refine_mask_config.py \
...
run_and_log "VOC" python cascadePSP.py \
      --input_root /home/sprice/PromptMoE/DATASETS/VOC/images \
      --pred_roots \
        /home/sprice/PromptMoE/DATASETS/VOC/outputs/DeepLabV3 \
        /home/sprice/PromptMoE/DATASETS/VOC/outputs/FCN \
        /home/sprice/PromptMoE/DATASETS/VOC/outputs/LR-ASPP \
      --output_dir /home/sprice/PromptMoE/paper_results/ablation/timeCheck/VOC/cascadePSP_fast \
      --fast True
...
run_and_log "VOC" python cascadePSP.py \
      ...
      --pred_roots \
        ...
        /home/sprice/PromptMoE/DATASETS/VOC/outputs/FCN \
        /home/sprice/PromptMoE/DATASETS/VOC/outputs/LR-ASPP \
      --output_dir /home/sprice/PromptMoE/paper_results/ablation/timeCheck/VOC/cascadePSP_slow \
      --fast False