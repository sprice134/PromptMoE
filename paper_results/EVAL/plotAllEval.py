...
def latex_head_to_head_ci_tables(all_strata_by_method, datasets, ours_name="SamRefiner-MoE", n_boot=3000, alpha=0.05):
    ...
    # Build IoU table
    iou_lines = []
    iou_lines.append("\\begin{table*}[t]")
...
python plotAllEval.py \
        /home/sprice/PromptMoE/results/SOTA_COMPARISON/results/BIG/ \
        /home/sprice/PromptMoE/results/SOTA_COMPARISON/results/DAVIS585/ \
        /home/sprice/PromptMoE/results/SOTA_COMPARISON/results/ECSSD/ \
        /home/sprice/PromptMoE/results/SOTA_COMPARISON/results/VOC/ \
        /home/sprice/PromptMoE/results/SOTA_COMPARISON/results/MSRA-B/ \
        --ours_name PromptMoE --exclude_name PromptMoE-All
...
python plotAllEval.py \
        ...
        --ours_name PromptMoE --exclude_name PromptMoE-All PromptMoE-Lite

python plotAllEval.py \
        /home/sprice/PromptMoE/paper_results/ablation/components/BIG/ \
        /home/sprice/PromptMoE/paper_results/ablation/components/DAVIS585/ \
        /home/sprice/PromptMoE/paper_results/ablation/components/ECSSD/ \
        /home/sprice/PromptMoE/paper_results/ablation/components/VOC/ \
        /home/sprice/PromptMoE/paper_results/ablation/components/MSRA-B/ \
        --ours_name Exp7
...
python plotAllEval.py \
        ...
        /home/sprice/PromptMoE/paper_results/ablation/timeCheck/MSRA-B \
        /home/sprice/PromptMoE/paper_results/ablation/timeCheck/VOC \
        --ours_name PromptMoE-Lite



python plotAllEval.py \
        /home/sprice/CVPR26_Dataset/final_results_Oct22/SOTA/CITYSCAPES \
        --ours_name PromptMoE --exclude_name PromptMoE-All PromptMoE-Lite
